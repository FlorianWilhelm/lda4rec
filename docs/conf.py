...
module_dir = os.path.join(__location__, "../src/lda4rec")
try:
...
try:
    from lda4rec import __version__ as version
except ImportError:
    pass
else:
    release = version
...
# If true, show page results after internal links.
